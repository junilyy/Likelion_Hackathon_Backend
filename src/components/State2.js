        ...
        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'center', height: '100vh', width: '100vw', marginBottom: 0, backgroundColor: '#F3F4F8' }}>
            ...
            <div className="Graphoutside" style={{ color: '#ffffff', backgroundColor: '#ffffff', width: 390, borderRadius: '10px', height: 280, flexDirection: 'column', justifyContent: 'center', alignItems: 'center', gap: 5, display: 'inline-flex' }}>
                <div className="Graph" style={{ width: 340, height: 240.65, position: 'relative', alignItems: 'center' }}>
                    ...
                    <div style={{ width: 15.58, left: 21.08, top: 220.65, position: 'absolute', textAlign: 'center', color: '#767676', fontSize: 14, fontFamily: 'Noto Sans KR', fontWeight: '500', wordWrap: 'break-word' }}>월</div>
                    <div style={{ width: 15.58, left: 66.97, top: 220.65, position: 'absolute', textAlign: 'center', color: '#767676', fontSize: 14, fontFamily: 'Noto Sans KR', fontWeight: '500', wordWrap: 'break-word' }}>화</div>
                    <div style={{ width: 15.58, left: 108.97, top: 220.65, position: 'absolute', textAlign: 'center', color: '#767676', fontSize: 14, fontFamily: 'Noto Sans KR', fontWeight: '500', wordWrap: 'break-word' }}>수</div>
                    <div style={{ width: 15.58, left: 156.16, top: 220.65, position: 'absolute', textAlign: 'center', color: '#767676', fontSize: 14, fontFamily: 'Noto Sans KR', fontWeight: '500', wordWrap: 'break-word' }}>목</div>
                    <div style={{ width: 15.58, left: 201.40, top: 220.65, position: 'absolute', textAlign: 'center', color: '#767676', fontSize: 14, fontFamily: 'Noto Sans KR', fontWeight: '500', wordWrap: 'break-word' }}>금</div>
                    <div style={{ width: 15.58, left: 245.99, top: 220.65, position: 'absolute', textAlign: 'center', color: '#767676', fontSize: 14, fontFamily: 'Noto Sans KR', fontWeight: '500', wordWrap: 'break-word' }}>토</div>
                    <div style={{ width: 15.58, left: 290.58, top: 220.65, position: 'absolute', textAlign: 'center', color: '#767676', fontSize: 14, fontFamily: 'Noto Sans KR', fontWeight: '500', wordWrap: 'break-word' }}>일</div>
                    <div className='rectnagle-container' style={{width : 340, height : 150 }}>
                    <div className="Rectangle2" style={{ width: 20.77, height: 68.20, left: 17.84, top: 142.31, position: 'absolute', background: '#FA7070', borderRadius: 10 }} />
                    <div className="Rectangle3" style={{ width: 20.77, height: 116.82, left: 62.43, top: 93.68, position: 'absolute', background: '#FA7070', borderRadius: 10 }} />
                    <div className="Rectangle4" style={{ width: 20.77, height: 41.42, left: 107.02, top: 169.08, position: 'absolute', background: '#FA7070', borderRadius: 10 }} />
                    <div className="Rectangle5" style={{ width: 20.77, height: 140.33, left: 151.61, top: 70.18, position: 'absolute', background: '#FA7070', borderRadius: 10 }} />
                    <div className="Rectangle6" style={{ width: 20.77, height: 101.82, left: 196.20, top: 108.68, position: 'absolute', background: '#F6A8A8', borderRadius: 10 }} />
                    <div className="Rectangle7" style={{ width: 20.77, height: 101.82, left: 240.80, top: 108.68, position: 'absolute', background: '#FA7070', borderRadius: 10 }} />
                    <div className="Rectangle8" style={{ width: 20.77, height: 101.82, left: 285.39, top: 108.68, position: 'absolute', background: '#FA7070', borderRadius: 10 }} />
                    </div>
                </div>
            </div>
